...
**Если смотреть на openat строки, то там постоянно появляется какой-то magic. man magic показывает что к его библиотекам обращается не только file, но и type, и test**
